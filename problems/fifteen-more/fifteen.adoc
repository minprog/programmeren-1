...
> Let op! Dit is de pagina van de hacker editie van Fifteen. Als je de niet-hacker versie van deze opdracht hebt gemaakt, lever deze opdracht dan in op de [niet-hacker editie pagina van Fifteen](/problems/fifteen-less).