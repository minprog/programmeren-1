...
[source,subs="macros"]
----
$ wget https://github.com/minprog/cs50x/raw/2020/fifteen/less/fifteen.zip
$ unzip fifteen.zip
$ rm fifteen.zip
$ cd fifteen
$ ls
