...
1. Execute `wget https://github.com/minprog/cs50x/raw/2020/resize/less/resize.zip` to download a (compressed) ZIP file with this problem's distribution.
...
[source]
----
check50 -l minprog/cs50x/2020/resize/less
----
