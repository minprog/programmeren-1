...
1. Execute `cd ~/module5` to ensure that you're in `~/module5` (i.e., a directory called `module5` that's in your home directory, aka `~`). If you haven't yet created that directory, create it now (remember how?).
