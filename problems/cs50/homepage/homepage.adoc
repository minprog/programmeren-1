...
1. Execute `mkdir module6` to make (i.e., create) a directory called `module6` in your home directory.
1. Execute `cd module6` to change into (i.e., open) that directory.
1. Execute `wget https://github.com/minprog/cs50x/raw/2020/homepage/homepage.zip` to download a (compressed) ZIP file with this problem's distribution.
...
Upload the your html and css files below. If you'd like, show your fancy homepage during the mentoring hour! 
