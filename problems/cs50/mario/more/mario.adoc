...
* Write, in a file called `mario.c` in your `~/module1/mario/more/` directory, a program that recreates these half-pyramids using hashes (`#`) for blocks.
...
[source]
----
check50 minprog/cs50x/2020/mario/more
----
