...
2.  Change into the `problems` directory.
...
[![](walkthrough.jpg)](https://video.cs50.io/o5Bkc7gtRjo)
</div>

[Open the problem walkthrough in the CS50 video player](https://video.cs50.io/o5Bkc7gtRjo)
...
<div markdown="1" class="extend">
[![](walkthrough.jpg)](https://video.cs50.io/Fo7Roe8hw3A)
</div>

[Open the solution walkthrough in the CS50 video player](https://video.cs50.io/Fo7Roe8hw3A)
</details>
...
Execute the below to evaluate the correctness of your code using `check50`. But be sure to compile and test it yourself as well!
    ...
    check50 cs50/labs/2021/x/worldcup -l
...
As soon as you're done, submit your `tournament.py` implementation, below! 

1. Toward CS50 IDE's top-left corner, within its "file browser" (not within a terminal window), control-click or right-click your `tournament.py` file (that's within your `problems/worldcup` directory) and then select **Download**. You should find that your browser has downloaded `tournament.py`.
