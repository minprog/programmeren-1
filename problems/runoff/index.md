...
<iframe src="https://asciinema.org/a/4rhSKgaZQsY93RLj0xgu7nwKB/iframe?autoplay=1&amp;cols=100&amp;loop=1&amp;rows=12" id="asciicast-iframe-4rhSKgaZQsY93RLj0xgu7nwKB" name="asciicast-iframe-4rhSKgaZQsY93RLj0xgu7nwKB" scrolling="no" allowfullscreen="true" title="Terminal session recording" style="overflow: hidden; margin: 0px; border: 0px; display: inline-block; width: 100%; float: none; visibility: visible; height: 256px;"></iframe>
...
<details markdown="1"><summary markdown="span">Understand the code in `runoff.c`</summary>
...
<details markdown="1"><summary markdown="span">Complete the `vote` function</summary>
...
<details markdown="1"><summary markdown="span">Complete the `tabulate` function</summary>
...
<details markdown="1"><summary markdown="span">Complete the `print_winner` function</summary>
...
<details markdown="1"><summary markdown="span">Complete the `find_min` function</summary>
...
<details markdown="1"><summary markdown="span">Complete the `is_tie` function</summary>
...
<details markdown="1"><summary markdown="span">Complete the `eliminate` function</summary>
