...
>
> Would you rather use a *trie*? That is the star assignment link:challenge[Speller Challenge], where you build a trie version next to this one and compare how fast the two are. Do the hash table first.
