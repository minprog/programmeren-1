...
hello = check50.import_checks("../py/hello")
import_checks(hello, prefix="hello_")

greedy = check50.import_checks("../py/greedy")
import_checks(greedy, prefix="greedy_")

mario = check50.import_checks("../py/mario")
import_checks(mario, prefix="mario_")

vigenere = check50.import_checks("../py/vigenere")
