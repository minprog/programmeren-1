...
* Execute `wget https://github.com/minprog/programmeren-1/raw/2022/problems/filter/small/filter.zip` to download a (compressed) ZIP file with this problem's distribution.
